...
class DocumentCiteTest(unittest.TestCase):
    ...
    def test_cite():
        cases = {
            '{{KMP|2/2009|rozdział=poznańskie budownictwo przeciwlotnicze w latach 30. i w czasie ii wojny światowej}}': {
